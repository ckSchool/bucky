...
if __name__ == "__main__":
    ...
    dls2 = DragListStriped(myApp.myFrame, style=wx.LC_REPORT|wx.LC_SINGLE_SEL)
    dls2.InsertColumn(0, "First Name")
    dls2.InsertColumn(1, "Last Name")
    dls2.InsertColumn(2, "Superhero Name")
    sizer = wx.BoxSizer()
    myApp.myFrame.SetSizer(sizer)
    sizer.Add(dls, proportion=1, flag=wx.EXPAND)
    sizer.Add(dls2, proportion=1, flag=wx.EXPAND)
