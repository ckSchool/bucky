...
from panel_course_fees    import course_fees
from panel_edit_school    import edit_school
from panel_edit_booking   import edit_booking
from panel_edit_address   import panel_edit_address

from panel_edit_guardian  import panel_edit_guardian
from panel_cSiswa_details import cSiswaDetails
...
from panel_edit_booking_student_details import edit_booking_student_details
...
class panel_login(wx.Panel):
    def __init__(self, *args, **kwds):
        ...
        self.text_ctrl_password = wx.TextCtrl(self,   -1, "password", style=wx.TE_PASSWORD)
    ...
    def __do_main(self):
        ...
        #sql = "UPDATE User SET password2 ='%s' WHERE NoIndukStaf ='S0103'" % x
        #fetch.updateDB(sql)
    ...
    def OnLogin(self, evt):
        ...
        sql = "SELECT * FROM User WHERE ID ='%s' AND password2='%s'" % (name, x)
