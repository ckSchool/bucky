...
from panel.student_bio              import panel_student_bio
from panel.filter_school_level_form import panel_filter_school_level_form

from wx.lib.pubsub import setupkwargs
from wx.lib.pubsub import pub

import dialog.EditStudentDetails
...
class panel_student_list(wx.Panel):
    ...
    def __set_properties(self):
        ...
        headings = [('id',50),('Name',250),('Form',150)]
    ...
    def __do_layout(self):
        ...
        sizer_bottom.Add(self.panel_right, 0, wx.EXPAND, 0)
