...
#from panel_edit_postcode import panel_edit_postcode
...
class panel_edit_postcode(wx.Panel):
	...
	self.edit(self.combo_kelurahan, self.combo_kecamatan)
    
    def EditKec(self, evt):
	#self.restore_str = fetch.cmbValue(self.combo_kecamatan)
	self.edit(self.combo_kecamatan, self.combo_kabupaten)
	
    def EditKab(self, evt):
	#self.restore_str = fetch.cmbValue(self.combo_kabupaten)
	self.edit(self.combo_kabupaten, self.combo_province)
    
    def EditProv(self, evt):
	#self.restore_str = fetch.cmbValue(self.combo_province)
	self.edit(self.combo_province,self.combo_country)
