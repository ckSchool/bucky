...
class DlgTransaction(wx.Dialog):
    def __init__(self, *args, **kwds):
        ...
        self.text_ctrl_ckrefno         = wx.TextCtrl(self.panel_trans_details,   -1, "", style = wx.TE_READONLY)
        ...
        self.text_ctrl_tans_descript   = wx.TextCtrl(self.panel_trans_details,   -1, "", style = wx.TE_MULTILINE)
    ...
    def __set_properties(self):
        #self.text_ctrl_tans_descript.SetMinSize((100,-1))
        psize=(420,200)
        ...
        #self.text_ctrl_tans_descript.SetMinSize((-1, -1))
        #self.text_ctrl_ckrefno.SetMinSize((230, -1))
    ...
    def __do_layout(self):
        ...
        grid_sizer_details.Add(self.text_ctrl_tans_descript, 0, wx.EXPAND, 0)
