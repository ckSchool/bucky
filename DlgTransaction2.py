...
class DlgTransaction(wx.Dialog):
    ...
    def newEntry(self, data):
        ...
        if debit_items:
            print 'add debit items to acc_journal_items '
            self.insertDebitItems(debit_items)
            
        if credit_items:
            print 'add credit items to acc_journal_items '
            self.insertCreditItems(credit_items)
            
    def insertDebitItems(self, debit_items):
        if debit_items: print 'add debit_items to acc_journal_items '
    ...
    def insertCreditItems(self, credit_items):
        if credit_items: print 'add credit items to acc_journal_items '
